...
本部分将专注于 JavaScript 语言本身，而非局限于网页或其他限制环境。想要了解网页有关的 [APIs](https://developer.mozilla.org//docs/Glossary/API)
，请参考 [Web APIs](https://developer.mozilla.org//docs/Web/API) 以及 [DOM](https://developer.mozilla.org//docs/Glossary/DOM)。
